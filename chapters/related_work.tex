...
Thorough experimentation with AR and ubicomp has only been possible in the last two decades or so, due to technological constraints. The first study concerning feedforward was published even more recently, in \citeyear{djajadiningrat2002but} \cite{djajadiningrat2002but}, and the topic hasn't so far been extensively researched \cite{vermeulen2013crossing}. For these reasons, literature combining AR, ubicomp and feedforward is still scarce (a notable exception is \cite{vermeulen2009bet}). However, there is a moderate set of publications that combine at least two of the topics, or that bring forth some relevant technique. Following is a discussion of selected works. \todo{Make some sections more in-depth, discuss earlier work, restructure, possibly add more related work.}
