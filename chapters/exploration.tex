...
\section{Survey} \label{sec:explor:survey}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\linewidth]{exploration/classroom_baseline.jpg}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\linewidth]{exploration/colors.jpg}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\linewidth]{exploration/shapes.jpg}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\linewidth]{exploration/floor_plan.jpg}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\linewidth]{exploration/switches_on_lights.jpg}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\linewidth]{exploration/lights_on_switches.jpg}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\linewidth]{exploration/lines.jpg}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\linewidth]{exploration/arcs.jpg}
        \caption{The \textit{colors} visualization, matching lights and switches by marking them with dots of the same color.}
